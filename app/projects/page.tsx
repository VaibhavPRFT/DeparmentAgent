...
export const metadata: Metadata = {
  title: "Project Teams — Royal Cyber Optimizely",
  description:
    "Royal Cyber Optimizely project teams — projects, team members and designations, with interactive views by project, project manager, account manager and delivery manager.",
};

...
// ---------------------------------------------------------------------------
// Curated catalogue of Royal Cyber's Optimizely accelerators. Each entry
// extends Optimizely with applied AI, analytics and automation and is mapped
// to the customer pain it solves, the ideal customer, and the value it creates
// for both Optimizely and Royal Cyber. Keep the shape stable so the
...
export interface Accelerator {
  n: string;            // "01"
  slug: string;         // anchor id, e.g. "optimizely-mcp-server"
...
export const accelerators: AcceleratorsData = {
  ...
  intro:
    "Each accelerator extends Optimizely with applied AI, analytics and automation — and answers a real customer pain. Built and proven by the Royal Cyber Optimizely Center of Excellence, they shorten time-to-value across B2B commerce, content management, analytics and digital asset management.",
  ...
  items: [
    {
      ...
      overview:
        "An MCP server layer on Configured Commerce lets buyers search in plain language, get contract pricing, and place orders through conversation — turning a large B2B catalog into a guided, AI-native ordering experience.",
      benefits: [
      ...
      idealCustomer:
        "Mid-to-large B2B distributors and manufacturers on Configured Commerce with complex catalogs, contract pricing, and busy CSR teams.",
      signals: [
      ...
      valueOptimizely:
        "An AI-native ordering experience that differentiates Configured Commerce and deepens platform usage.",
      valueRoyalCyber:
    ...
    },
    {
      ...
      overview:
        "An automated framework carries Optimizely CMS through the 11 → 12 → 13 upgrade path with intelligent compatibility checks — far less manual effort and materially lower migration risk.",
      benefits: [
        { title: "Reduced Upgrade Risk", text: "Compatibility issues are surfaced before migration begins." },
        { title: "Faster Delivery", text: "Less manual code review and regression testing." },
        { title: "Future-Proof Platform", text: "Lands on a cloud-native, secure, current platform." },
      ],
      technical: [
      ...
      idealCustomer:
        "Optimizely CMS customers on CMS 11 or early 12, facing rising cost or support deadlines, who want CMS 13 without a risky rebuild.",
      signals: [
      ...
      valueOptimizely:
        "Moves customers to the latest supported CMS, reducing legacy support and lifting adoption.",
      valueRoyalCyber:
        "Defined-scope upgrade engagements plus follow-on enhancement and optimization.",
    },
    {
      n: "03",
      ...
      overview:
        "Commerce, ERP and inventory data are unified into one connected dataset and surfaced as live Power BI dashboards inside Configured Commerce — replacing scheduled pulls and disconnected exports.",
      benefits: [
        ...
        { title: "Executive Scorecards", text: "Leadership views built into the commerce platform." },
      ],
      technical: [
      ...
      idealCustomer:
        "Configured Commerce customers running ERP and inventory in separate systems, where teams rely on manual or scheduled reports.",
      signals: [
      ...
      valueOptimizely:
        "Positions Configured Commerce as an operational hub, keeping analytics on the platform.",
      valueRoyalCyber:
    ...
    },
    {
      ...
      overview:
        "AI-assisted tagging brings thousands of assets into Optimizely DAM in hours, applying consistent categories, keywords and taxonomy automatically as files are ingested.",
      benefits: [
        { title: "Hours, Not Weeks", text: "Rapid migration of large asset libraries into DAM." },
        { title: "Consistent Metadata", text: "Categories, keywords and taxonomy applied automatically." },
        { title: "Improved Searchability", text: "Teams find the right asset on the first search." },
      ],
      technical: [
      ...
      idealCustomer:
        "Optimizely DAM customers and prospects with large or growing libraries, multiple contributing teams, and inconsistent metadata.",
      signals: [
      ...
      valueOptimizely:
        "Accelerates DAM adoption and time-to-value, supporting attach and renewal.",
      valueRoyalCyber:

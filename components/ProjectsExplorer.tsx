                ...
                return (
                  ...
                  >
                    ...
                    <div className="mt-1.5 h-3.5 w-full overflow-hidden rounded-full bg-opti-chip">
                      <div
                        className="h-full rounded-full bg-gradient-to-r from-[#0e7a40] to-[#1f9a57]"
                        style={{ width: `${pct}%` }}
                      />
                    </div>
                  </button>
          ...
          <div className="mt-5 space-y-4">
            {visibleProjects.map((p) => {
              ...
              return (
                ...
                >
                  <div className="flex flex-wrap items-center justify-between gap-3 border-b border-opti-line bg-gradient-to-r from-[#eef7f1] to-white px-5 py-4">
                    <div>
                    ...
                    <table className="w-full border-collapse text-[13.5px]">
                      ...
                      <tbody>
                        {p.members.map((m, i) => (
                          <tr
                            key={i}
                            className="odd:bg-white even:bg-[#f6fbf8]"
                          >
